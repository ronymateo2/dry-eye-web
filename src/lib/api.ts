...
export const api = {
  ...
  searchObservations: (q: string) => api.get<{ id: string; title: string; eye: string; notes: string | null; last_logged_at: string | null; occurrence_count: number; matched_note: string | null }[]>(`/observations/search?q=${encodeURIComponent(q)}`),
